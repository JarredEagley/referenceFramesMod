...
namespace nubeees_refFrame
{
    public static class Util
    {
        ...
        public static void DrawDebugSphere(Vector3D position, float radius)
        {
            ...
            Color color = (Color.Lime * 0.75f).ToVector4();
            float wireframethickness = 0.1f;
            MySimpleObjectDraw.DrawTransparentSphere(ref matrix, radius, ref color, MySimpleObjectRasterizer.SolidAndWireframe, 360/15, lineThickness:wireframethickness);
        }
    }
}
