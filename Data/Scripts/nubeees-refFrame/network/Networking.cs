...
/// <summary>
/// Credit to Digi!
/// https://github.com/THDigi/SE-ModScript-Examples/blob/master/Data/Scripts/Examples/Example_NetworkProtobuf/Networking.cs
/// 
/// Modified to use 'secureMessageHandler'
/// </summary>
namespace nubeees_refFrame.network
{
    ...
    public class Networking
    {
        ...
        /// <summary>
        /// Note to self: Doesn't currently apply handlerID, steamID, or fromServer at all!
        /// </summary>
